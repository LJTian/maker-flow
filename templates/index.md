...
| **suggested_patterns** | `retry-backoff`, `circuit-breaker`, `singleflight-cache`, `persistence-d1` |
...
Need DB / tables? → + persistence-d1 into go-api (Cloudflare D1 online + Docker local)
