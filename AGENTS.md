...
| 5 | Human | Approve MVP | `skills/mvp-acceptance.md`, `prompts/05-accept-mvp.md`, product `pro.md` | pass/fail (+ agent evidence package) |
| 6 | Agent (on approve) | Publish | `skills/deploy.md`, `prompts/06-publish.md`, `skills/publish-<target>.md` | public URL(s) |
